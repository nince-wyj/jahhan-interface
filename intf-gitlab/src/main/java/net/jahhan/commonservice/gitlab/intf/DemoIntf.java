package net.jahhan.commonservice.gitlab.intf;
...
import net.jahhan.commonservice.gitlab.vo.UserNameIVO;
import net.jahhan.commonservice.gitlab.vo.UserOVO;
import net.jahhan.commonservice.gitlab.vo.UserRegistIVO;
import net.jahhan.commonservice.gitlab.vo.UserRegistOVO;
