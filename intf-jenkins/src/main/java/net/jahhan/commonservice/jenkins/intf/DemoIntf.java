package net.jahhan.commonservice.jenkins.intf;
...
import net.jahhan.commonservice.jenkins.vo.UserNameIVO;
import net.jahhan.commonservice.jenkins.vo.UserOVO;
import net.jahhan.commonservice.jenkins.vo.UserRegistIVO;
import net.jahhan.commonservice.jenkins.vo.UserRegistOVO;
